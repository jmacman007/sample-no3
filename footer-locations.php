...
<div class="container-fluid">
				...
				<div class="container">
					<div class="row">
						<?php if ( is_page( 'location-1-detail' )) { ?>
							<?php get_template_part('inc/oneOther'); ?>
						<?php } else if ( is_page( 'location-2-detail' )) { ?>
							<?php get_template_part('inc/twoOther'); ?>
						<?php } else if ( is_page( 'location-3-detail' )) { ?>
							<?php get_template_part('inc/threeOther'); ?>
						<?php } else { ?>
							<?php get_template_part('inc/fourOther'); ?>
						<?php } ?>
				  </div><!-- /row -->
				</div>
			</section>
	...
	<div class="row">
		<footer id="colophon" class="site-footer locations" role="contentinfo">
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						<div class="logoHours">
